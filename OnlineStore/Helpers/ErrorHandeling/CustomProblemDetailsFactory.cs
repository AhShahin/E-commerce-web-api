...
{
    public class CustomProblemDetailsFactory : Microsoft.AspNetCore.Mvc.Infrastructure.ProblemDetailsFactory
    {
            ...
            string instance = null)
        {
            ...
            {
                if (context.Error is IApplicationException ybe)
                {
                    statusCode = 400;
                    ...
                    {
                        Status = Convert.ToInt32(ybe.StatusCode),
                        Title = ybe.Title,
                        Type = ybe.Type,
                        Detail = ybe.Message,
                        Instance = instance,
